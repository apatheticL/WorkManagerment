...
class CustomDialog(val actionId: Int, val groupId: Int, val call: SendUserTeam) : DialogFragment(),
    DialogUserTeamContract.View {
    private var presenter: DialogUserTeamPresenter? = null
    private lateinit var userTeamResponse: UserTeamResponse
    private var checkOnClick = false
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        buttonChoose.setOnClickListener {
            if (checkOnClick) {
                ...
                Toast.makeText(context,"Can chon thanh vien thuc hien",Toast.LENGTH_SHORT).show()
            }
        }
    }
