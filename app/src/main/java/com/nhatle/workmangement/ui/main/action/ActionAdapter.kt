...
class ActionAdapter(private val call: SendData) :
    ...
    class ActionHolder(itemView: View, val call: SendData) :
        ...
        private fun initDataHolder(
            ...
            if (itemData.creatorId ==CommonData.getInstance().profile!!.profileId){
                itemData1.cardViewItemWork.setCardBackgroundColor(call.getContext().resources.getColor(R.color.colorItem))
            }
