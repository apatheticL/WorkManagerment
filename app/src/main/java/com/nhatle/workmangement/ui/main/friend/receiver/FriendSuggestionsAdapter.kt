...
class FriendSuggestionsAdapter(val call: SendDataProfile.ReceiverFriend):
    ...
    override fun onBindViewHolder(holder: ReceiverFriendHolder, position: Int) {
        ...
        regusterAvatarClick(holder.itemView.imageAvatarFriend,getData()[position].friendId)
    ...
    private fun regusterAvatarClick(imageAvatarFriend: CircleImageView, friendId: Int) {
