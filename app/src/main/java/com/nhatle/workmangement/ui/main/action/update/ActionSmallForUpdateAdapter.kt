...
class ActionSmallForUpdateAdapter(val callback: SendActionSmall) :
    ...
    override fun onBindViewHolder(holder: ActionSmallHolder, position: Int) {
        ...
        registerItemClick(holder.itemView, getData()[position])
    ...
    private fun registerItemClick(itemView: View, actionSmall: ActionSmall) {
        itemView.setOnClickListener {
            callback.sendActionSmall(actionSmall)
        }
    }
    ...
    interface SendActionSmall {
        fun sendActionSmall(data: ActionSmall)
